...
.. note::
    The ``pro fix`` command is part of the Ubuntu Pro Client (``pro``), which is a security tool for Ubuntu systems. If you don't have it installed, you can install it by following the instructions in the ``pro`` package documentation.
...
Here, for example, We will choose to fix a CVE that does not affect the system -- for example if you do not have ``MariaDB`` installed `CVE-2020-15180`_.
